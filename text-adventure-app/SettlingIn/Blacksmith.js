...
export class Blacksmith {
	...
	static createPage(that){
		...
		if(SettlingInData.Gold > 0){
			...
			that.preparePage("bow.");
		}
		
		//can buy nothing
		if(SettlingInData.Gold < 1){
			SettlingInData.Blacksmith = false; 
			that.preparePage(" Unfortunately, you don't have any gold. Looks like you'll have to ");
