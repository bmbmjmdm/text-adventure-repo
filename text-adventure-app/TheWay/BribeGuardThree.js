...
export class BribeGuardThree {
	...
	static createPage(that){
		...
		//passive
			...
			that.preparePage("The young man is speechless, holding his sword towards you as he bends down to pick up the gold. He examines it, then you. Eyes wide, the young man puts his sword away and goes about his business, trying to forget you're there. This leaves you to do what you will in this ");
...
static getName(){ return "BribeGuardThree"; }
}