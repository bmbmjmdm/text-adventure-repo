...
export class AmbushGuardOne {
	...
	static createPage(that){
		...
		if(TheWayData.HasWeapon.Glass){
			...
			damage = 1; 
			this.preparePage("You grab the guard by her head and drive her into the hot, metal bars of the door. She lets out a scream and pushes you off her, new scars adorning her face. She takes 1 damage and looks pretty well done. ");
		}
