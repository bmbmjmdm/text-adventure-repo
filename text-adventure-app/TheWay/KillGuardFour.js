...
export class KillGuardFour {
	...
	static createPage(that){
		...
		that.preparePage(" and regain some morality. But there's no need, just the feint whines and shallow breaths that intice you to sleep better at night. As you ponder this, you pick up the axe from the slain guardsman. It's heavy, but looks useful. ");
		if(!TheWayData.HasBag){
			TheWayData.HasBag = true;
			that.preparePage("You gather a strap from the shelves and attach it to your back. You also find a small bag that'll be useful for storing things, should you find any. ");
		}
		that.preparePage("The metal gate at the end of this room is hooked up to a rotating pully system. It should be easy enough to use, if you want to ");
