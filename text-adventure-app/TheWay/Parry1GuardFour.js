...
export class Parry1GuardFour {
	...
	static createPage(that){
		...
		that.preparePage("You take a breath in and duck a shoulder, bringing your blade between the axe and you. It catches beneath the head and you push it up into the air, throwing the guard off balance and his attack skyward. Coming down from the parry you slash across the guard's chest, dealing 2 damage. Just as his hand comes up to feel the wound and his axe steadies in front, preparing for a second assault, you turn around to see the other guard just now changing stance. With nothing to parry, he decides to use the opportuntiy to stab forward, hoping to catch you as you spin. Do you ");
