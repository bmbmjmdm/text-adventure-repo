...
export class RockyFlatHunt {
	...
	static createPage(that){
		...
		that.preparePage(" You feel tired, after all, with about "+YourWorldData.Energy+" energy. The thought comes to you... this will be the first meal you eat outside those bars in God knows how long. You chuckle at the thought of God and the memory of that guard, before the night air chills the joy the from your lungs.");
