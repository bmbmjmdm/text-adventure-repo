...
export class ClimbSuccess {
	...
	static createPage(that){
		...
		if(YourWorldData.Allies > 0){
			that.preparePage("You call down to your allies and instruct them how to climb, where to hold, where not to, and offer a hand for the last jump so they have no trouble surmounting it. ");
