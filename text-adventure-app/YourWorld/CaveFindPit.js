...
export class CaveFindPit {
	...
	static createPage(that){
		that.preparePage("As you go deeper into the cave, the air oddly cool, the dripping drawing closer, you see ahead of you a cliff. You lower yourself to your hands and knees, even though there's room to stand, because slippery rocks + cliff inside cave = fuck that. You approach with shallow breaths. You then see it: the drip. There's dripping water just in front of the edge, coming from a ceiling you can't quite make out in this darkness, but steadily dropping one gobule of water per two seconds. You look below and see a ten foot drop into what looks like a pool of water. There're edges surrounding it, making this more of a pit. About five feet or so across, not very large. You see some odd looking stones sticking out of the water but can't make them out with your torch. Not from this distance. Looking around there's no other way to go, this is probably the end. ");
...
static getName(){ return "CaveFindPit"; }
}