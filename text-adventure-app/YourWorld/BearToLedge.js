...
export class BearToLedge {
	...
	static createPage(that){
		...
		that.preparePage("You holster your "+weapon+" and, after a few deep breaths, move forward. The path winds upward steeply, grass overcome by dirt and shrubs infrequent. As suddenly as it started, it stops, and you find yourself at a precipice of grass. There's a ledge it looks like, and as you step up you can see a good twenty or thiry feet down a rock wall onto a steep, rocky slope below. You step back from the edge, back into the ");
