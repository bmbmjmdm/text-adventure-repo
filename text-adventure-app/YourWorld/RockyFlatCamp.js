...
export class RockyFlatCamp {
	...
	static createPage(that){
		...
		that.preparePage("You clear a patch of ground that looks as not-lumpy as possible. The stairs begin peaking out from the sky as distant planets revolve. What was once a hot day turns chill, frigid, the wind beating the side of the mountain endlessly. But at least you're free. ");
