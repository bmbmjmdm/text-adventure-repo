...
export class MediumFire {
	...
	static createPage(that){
		...
		if(YourWorldData.FinalCamp){
			that.preparePage(" After thawing your fingers and toes, the flickering heat gives you an idea. You venture out of the cove for only a moment, coming back with a waterskin overflowing with snow. You balance it above the fire and eventually melt it down, making several portions of potable water!");
