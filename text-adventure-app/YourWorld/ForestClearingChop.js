...
export class ForestClearingChop {
	...
	static createPage(that){
		...
		if(YourWorldData.Allies.OldGuy){
			...
			that.preparePage("You hold the "+using+" in your hands and steady your feet, taking a few deep breaths and preparing for the carnage. Your first few chops are wild, never hitting the same place twice, but your determination leads to enough damage that the trunk begins wavering. You press your foot against it and push, hearing its fibers snap and crack as the trunk bows. ");
		}
