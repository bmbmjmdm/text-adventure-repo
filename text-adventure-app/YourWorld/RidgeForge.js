	...
	static createPage(that){
		...
		if(YourWorldData.Allies > 0){
			...
			if(YourWorldData.SadGal){
				that.preparePage("For some reason it looks like the girl, who's morose most of the time, is now plowing away at the gravel somewhat amused. She peaks up every now and then, watching the others work and stomping the ground dutifully when it's her turn. ");
			}
		}
