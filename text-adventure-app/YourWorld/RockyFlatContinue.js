...
export class RockyFlatContinue {
	...
	static createPage(that){
		that.preparePage("Dawn sheds light on your small, makeshift camp. As you stand up and stretch, your back aching from a night spent cuddling dirt, you gaze up at the task ahead. The rock wall is daunting, towering over you in a miserably vertical fashion. If you want to go up, you'll have to ");
...
static getName(){ return "RockyFlatContinue"; }
}