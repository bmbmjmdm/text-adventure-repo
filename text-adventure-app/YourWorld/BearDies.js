...
export class BearDies {
	...
	static createPage(that){
		...
		that.preparePage("After a few moments to yourself, putting pressure on the wounds through any means available, you heart begins to steady. You caugh a bit as you stand up, weak, but knowing you can't stay here long. ");
